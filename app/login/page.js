...
const LoginPage = () => {
    ...
    <div className='flex min-h-screen flex-col items-center justify-center py-24 px-3'>
        ...
        <form className='flex flex-col justify-center items-center gap-2 py-4 w-full max-w-md'>
            ...
            <button className='border my-3 mt-5 p-[8px_20px] bg-transparent text-white border-white rounded hover:bg-[#63c34e] hover:text-black hover:border-transparent focus:border-transparent focus:bg-[#63c34e] focus:text-black transition' >Login</button>
        </form>
